...
SELECT
    ...
    'https://via.placeholder.com/600x400?text=Digital+Frontier',
...
SELECT
    ...
    'https://via.placeholder.com/600x400?text=Scenic+Vistas',
...
SELECT
    ...
    'https://via.placeholder.com/600x400?text=Java+Tutorial',
...
SELECT
    ...
    'https://via.placeholder.com/600x400?text=Inspiration',
...
SELECT
    ...
    'https://via.placeholder.com/600x400?text=Future+AI',
    (SELECT id FROM template WHERE name = 'Blog Post'),
    (SELECT id FROM users WHERE username = 'uitestuser'),
    'PUBLISHED',
